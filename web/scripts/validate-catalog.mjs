...
const allowed = { rarity: ["Common","Uncommon","Legendary","Boss","Lunar","Void"], scope: ["Base Game","Survivors of the Void","Seekers of the Storm","Alloyed Collective"], sourceStatus: ["verified","wiki-derived","needs-review"], priority: ["core","useful","skip","scrap"] };
